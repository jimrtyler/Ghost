...
Export-ModuleMember -Function Set-ICMP, Set-RDP, Set-LLMNR, Set-NetBIOS, Set-LDAP, Set-PSRemoting, Set-SMBv1, Set-Firewall, Set-RemoteAssistance, Set-NetworkDiscovery, Set-Ghost, Get-Ghost, Get-Service